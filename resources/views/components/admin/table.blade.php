<div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
    ...
    <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
            <thead>
                <tr class="border-b-2 border-gray-300 px-6 text-left text-sm leading-4 text-blue-500">
                    <th class="px-6 py-3 tracking-wider">ID</th>
                    <th class="px-6 py-3 tracking-wider">Fullname</th>
                    <th class="px-6 py-3 tracking-wider">Email</th>
                    <th class="px-6 py-3 tracking-wider">Phone</th>
                    <th class="px-6 py-3 tracking-wider">Status</th>
                    <th class="px-6 py-3 tracking-wider">Created At</th>
